export interface Track {
  ...
  category?: string
  audioUrl: string
  /** ID do vídeo no YouTube para tocar a música original. Quando definido, usa YouTube em vez do áudio. */
...
export const recentTracks: Track[] = [
  { id: '1', title: "The First Time", artist: "Damiano David", type: "Música", coverUrl: "https://images.unsplash.com/photo-1614680376593-902f74cf0d41?w=400&h=400&fit=crop", category: "Energia", audioUrl: `${SOUNDHELIX}-1.mp3`, youtubeVideoId: "g4HERPfpn8o" },
  ...
  { id: '4', title: "we can't be friends (wait for your love)", artist: "Ariana Grande", type: "Música", coverUrl: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400&h=400&fit=crop", views: "348 mi de visualizações", category: "Romance", audioUrl: `${SOUNDHELIX}-4.mp3`, youtubeVideoId: "DhK0fZ_hs04" },
  { id: '5', title: "Tubarões (Ao Vivo)", artist: "Diego & Victor Hugo", type: "Música", coverUrl: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=400&h=400&fit=crop", category: "Festa", audioUrl: `${SOUNDHELIX}-5.mp3`, youtubeVideoId: "10XarNSkw0s" },
